...
echo_and_run cd "/home/casch/yumi_depends_ws/src/MoveIt/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/casch/yumi_depends_ws/build/MoveIt/universal_robot/ur_kinematics" \
    install \
    $DESTDIR_ARG \
